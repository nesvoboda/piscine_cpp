...
/*   Updated: 2020/09/29 18:27:07 by ashishae         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &f)
{
	...
	{
		std::cout << *this << " cannot sign form " << f << " because " << e.what() << std::endl;
	}
...
void Bureaucrat::executeForm(Form const &form)
{
	...
	{
		std::cout << *this << " cannot execute form " << form << " because " << e.what() << std::endl;
	}
